        ...
        <div class="row">
                    ...
                    <div class="widget catagory mb-50">
                        ...
                        <div class="catagories-menu">
                            <ul>
                                ...
                                <li><a href={{route('users.edit')}}> Miei dati</a></li>
                                <li><a href="/adress">  I miei indirizzi</a></li>
                                <li><a href="/my_card">  Le mie carte</a></li>
            ...
            <div class="destinazione">
                 ...
                 <div id="d" class="col-12 col-md-8 col-lg-9">
                     ...
                     <h3> Benvenuto/a {{ Auth::user()->name }}!</h3>

                                <P>
                                    Dal tuo account ESSENCE puoi gestire i tuoi ordini, dati e dettagli degli indirizzi.</P>
